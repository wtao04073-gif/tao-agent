export function selectBranchFork(options, source) {
...
export function projectForkCurrentStateWrite(write, plan, isEntryCopied) {
    ...
    if (write.namespace.startsWith("pi.op.") || write.namespace.startsWith("pi.pending."))
        return undefined;
